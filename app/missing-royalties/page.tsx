...
<head>
  ...
  <title>TrapRoyalties Pro â€“ Find Missing Royalties</title>
  ...
  <main className="pt-28 pb-20 px-6 max-w-5xl mx-auto">
    <div className="text-center mb-12">
      ...
      <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto">
        Hunt down unclaimed bags from streams, syncs, performances & playlists. Scan major PROs (ASCAP, BMI, SOCAN, PRS) for gaps â€” especially in hip hop collabs, features, & R&B hooks.
      </p>
      <p className="mt-4 text-lg text-purple-300 font-medium">Free basic search â€¢ Real-time estimates â€¢ Upgrade for full recovery & on-chain proof</p>
    </div>
    ...
    <div className="bg-gray-900/60 backdrop-blur-md rounded-3xl shadow-2xl border border-purple-900/50 p-8 md:p-12">
      ...
      <div className="relative mb-8">
        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="absolute left-5 top-1/2 transform -translate-y-1/2 h-8 w-8 text-purple-400"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
        <input type="text" placeholder="Enter name (e.g., Future, Metro Boomin, SZA, The Weeknd)" className="w-full pl-16 pr-6 py-6 text-xl bg-gray-800 border-2 border-purple-900/50 rounded-2xl focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-600 text-white placeholder-gray-400"/>
      </div>
      ...
      <button className="w-full py-6 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-full font-bold text-2xl hover:from-purple-500 hover:to-pink-500 shadow-2xl shadow-purple-900/50 transition transform hover:scale-105 flex items-center justify-center">
        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mr-4"><circle cx="11" cy="11" r="8"/><path d="m21 21-4.3-4.3"/></svg>
        Search for Missing Royalties
      </button>

      <p className="text-center mt-6 text-gray-400 text-lg">Free basic search (limited results) â€¢ Full catalog scan + detailed recovery in <a href="/free-audit" className="text-purple-400 hover:text-purple-300 underline">Free Audit</a></p>
    </div>

    <!-- Features / Benefits -->
    <div className="mt-20 grid md:grid-cols-3 gap-10">
      <div className="text-center bg-gray-900/40 rounded-2xl p-8 border border-purple-800/30">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mx-auto mb-6"><circle cx="12" cy="12" r="10"/><path d="M2 12h20"/></svg>
        <h3 className="text-2xl font-bold neon-purple mb-4">Global PRO Coverage</h3>
        <p className="text-gray-300">Scans ASCAP, BMI, SOCAN, PRS & more â€” find unclaimed from viral TikToks to radio spins.</p>
      </div>
      <div className="text-center bg-gray-900/40 rounded-2xl p-8 border border-purple-800/30">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#06b6d4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mx-auto mb-6"><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></svg>
        <h3 className="text-2xl font-bold neon-cyan mb-4">Real-Time Estimates</h3>
        <p className="text-gray-300">Instant insights on potential missing earnings â€” see where your streams/synchs fell through cracks.</p>
      </div>
      <div className="text-center bg-gray-900/40 rounded-2xl p-8 border border-purple-800/30">
        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#a855f7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="mx-auto mb-6"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
        <h3 className="text-2xl font-bold neon-purple mb-4">Claim Your Bag</h3>
        <p className="text-gray-300">Link to recovery tools â€” upgrade for crypto-verified claims & payment simulation.</p>
      </div>
    </div>
    ...
    <div className="mt-16 text-center">
      ...
      <p className="text-xl text-gray-300 mb-8">Basic search shows gaps â€” full power (unlimited, monitoring, on-chain proof) in Royalty Accelerator.</p>
      <a href="/accelerator" className="inline-block bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-bold py-6 px-12 rounded-full text-2xl shadow-2xl shadow-pink-900/50 transition transform hover:scale-105">
        Join Accelerator â€“ Limited Spots
      </a>
    </div>
  </main>
  ...
  <footer className="py-12 bg-black border-t border-purple-900/30 text-center text-gray-500">
    <p>Â© 2026 TrapRoyalties Pro. Built for the culture. All rights reserved.</p>
